...
class WellDressedFluorescentYellowFrog(QCAlgorithm):
    ...
    def Initialize(self):
        ...
        self.SetStartDate(2017, 6, 30)  # Set Start Date format year, month, datea
        ...
        #self.Schedule.On(dateRule, timeRule, callback)
    ...
    def EveryMarketOpen(self):
        ...
        if self.Securities[self.symbol].Invested:
            ...
            if self.Securities[self.symbol].Close > self.highestPrice and self.initialStopRisk * self.breakoutlvl * self.breakoutlvl < self.Securities[self.symbol].Close * self.trailingStopRisk:
